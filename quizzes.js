window.AM_QUIZZES = [

  {
    ...
    questions: [
      ...
      {
        id: 1,
        question: "The divisional plane in the picture is called the:",
        options: [
          "Transverse",
          "Sagittal",
          "Frontal"
        ...
        correct: 0,
        explanation: "A transverse plane divides the body horizontally into superior and inferior portions."
      },

      {
        id: 2,
        question: "500 mL is the same as:",
        options: [
          "50 L",
          "0.5 L",
          "5 L",
      ...
      {
        id: 3,
        question: "The correct volume measured in the syringe is:",
        options: [
          "3.2 mL",
          "3.3 mL",
          "3.4 mL",
        ...
        correct: 2,
        explanation: "The syringe is read at the leading edge of the plunger, which indicates 3.4 mL."
      },

      {
        ...
        correct: 0,
        explanation: "A frontal or coronal plane divides the body into anterior and posterior portions."
      },

      {
        id: 5,
        question: "1 cc is the same volume as:",
        options: [
          "1 cubic centimetre",
          "1 cm³",
          "1 mL",
        ...
        correct: 3,
        explanation: "1 cc = 1 cubic centimetre = 1 cm³ = 1 mL."
      },

      {
        id: 6,
        question: "The correct abbreviation for kilograms is:",
        options: [
          "kg",
          "KG",
          "Kg",
        ...
        correct: 0,
        explanation: "The standard SI symbol for kilogram is kg."
      },
      ...
      {
        id: 8,
        question: "In a cup of instant black coffee, the coffee is the:",
        options: [
          "Solute",
          "Solvent"
        ],
        correct: 0,
        explanation: "The substance being dissolved is the solute. Water is the solvent."
      },

      {
        id: 9,
        question: "True or False? My thumb is lateral to my little finger.",
        options: [
          "True",
          "False"
        ],
        correct: 0,
        explanation: "In anatomical position, the thumb is farther from the body's midline than the little finger."
      },

      {
        ...
        options: [
          "My lungs are superficial to my skin",
          "My head is superior to my heart",
          "My toes are distal to my knee",
          "My nose is anterior to my ears"
        ],
        correct: 0,
        explanation: "The lungs are deep to the skin, not superficial. The other directional statements are correct."
      }
...

  {
    ...
    questions: [
      ...
      {
        id: 1,
        question: "What are the 4x, 10x, 40x and 100x magnifying lenses called?",
        options: [
          "fine focus control",
          "objectives",
        ...
        correct: 1,
        explanation: "The 4x, 10x, 40x and 100x magnifying lenses are the objective lenses."
      },

      {
        id: 2,
        question: "The photomicrograph is of a slide of",
        options: [
          "neurons",
          "skeletal muscle",
          "blood cells",
        ...
        correct: 2,
        explanation: "The image shows many erythrocytes, so the specimen is blood cells."
      },

      {
        ...
        options: [
          "Sausage shaped with many folds of membranes",
          "To make lipids",
          "To recycle proteins",
...

      {
        ...
        correct: 1,
        explanation: "Adipocytes are fat cells specialised for energy storage."
      },

      {
        id: 5,
        question: "Which of these is not found inside a cell?",
        options: [
          "intracellular fluid",
          "cytoplasm",
          "extracellular fluid",
        ...
        correct: 2,
        explanation: "Extracellular fluid is outside the cell."
      },

      {
        id: 6,
        question: "What is visible in the cheek cell at a total magnification of 400x?",
        options: [
          "Cell membrane, nucleus, cytoplasm",
          "Mitochondria, nucleus, cytoplasm",
          "Cell membrane, cytoplasm, Golgi body",
          "Endoplasmic reticulum, cell membrane, nucleus"
        ],
        correct: 0,
        explanation: "At 400x, the cell boundary, cytoplasm and stained nucleus can be seen."
      },

      {
        id: 7,
        question: "If you are using a microscope, what is the total magnification with the 10x objective?",
        options: [
          "10x",
          "100x",
          "400x",
        ...
        correct: 1,
        explanation: "10x eyepiece × 10x objective = 100x total magnification."
      },

      {
        id: 8,
        question: "True or False? Erythrocytes do not have a nucleus.",
        options: [
          "True",
          "False"
        ],
        correct: 0,
        explanation: "Mature human erythrocytes do not have a nucleus."
      },

      {
        id: 9,
        question: "When looking at cells under a microscope, samples are often stained. What is the reason for this staining?",
        options: [
          "To make them look nice",
          "To make them visible",
          "To dissolve them",
          "To remove them from the slide"
        ],
        correct: 1,
        explanation: "Staining increases contrast and makes transparent cell structures easier to see."
      },

      {
        id: 10,
        question: "Why is the coarse focus used only with the 4x objective and not the 40x or 100x?",
        options: [
          "It won't move the stage",
          "It moves the stage a large distance up and down very quickly",
          "It moves the stage a tiny amount only",
          "It only moves the stage left and right"
        ],
        correct: 1,
        explanation: "Coarse focus moves the stage a large distance, which can damage the slide or objective at high magnification."
      }
